...
* **Liczba wszystkich plików:** 1627
* **Liczba katalogów:** 247
* **Data aktualizacji:** 2026-09-03T23:56:32.799Z
...
- **apps/** (1232) — Aplikacje wykonawcze i powłoki klienckie w monorepo
  ...
  - **web/** (759) — Aplikacja webowa React/Vite (Admin, Client, Timeline, Mikser)
    ...
    - **src/** (715) — Kod źródłowy UI i logiki klienta
