...
* **Liczba wszystkich plików:** 1643
* **Liczba katalogów:** 247
* **Data aktualizacji:** 2026-09-04T00:15:19.053Z
...
- **apps/** (1242) — Aplikacje wykonawcze i powłoki klienckie w monorepo
  ...
  - **web/** (769) — Aplikacja webowa React/Vite (Admin, Client, Timeline, Mikser)
    ...
    - **src/** (725) — Kod źródłowy UI i logiki klienta
      - **dev/** (18) — Narzędzia i panele deweloperskie wewnątrz aplikacji
      - **lib/** (249) — Biblioteki klienta (5 kategorii — bez plików w lib root)
        - **audio/** (64) — DSP, AudioContext, tempo, waveform
      ...
      - **shells/** (432) — Powłoki Admin / Client / Timeline
      - **transport/** (17) — Transport WS, playhead, probe wydajności
...
- **packages/** (222) — Współdzielone pakiety wewnętrzne monorepo
  ...
  - **plugins/** (4)
  - **shared/** (179) — Logika domenowa SSOT, Zod schematy, przeliczenia czasu i akordów
...
│   │   │   │   └── devSurfaceTypes.ts
│   │   │   ├── lib/
│   │   │   │   ├── audio/  … (64 pliki, 2 podkatalogi; 45 plików bezpośrednio)
...
│   │   │   │   ├── shared/  … (2 pliki)
│   │   │   │   └── timeline/  … (185 plików, 10 podkatalogów; 13 plików bezpośrednio)
│   │   │   ├── transport/
│   │   │   │   ├── api.test.ts
│   │   │   │   ├── api.ts
...
│   │   │   │   ├── transport.test-helpers.tsx
│   │   │   │   ├── transportContext.ts
│   │   │   │   ├── TransportProvider.test.tsx
│   │   │   │   ├── TransportProvider.tsx
│   │   │   │   ├── TransportProviderMessages.test.tsx
...
│   │   │   │   ├── smart-tempo-grid.test.ts
│   │   │   │   ├── smart-tempo-nodes.test.ts
│   │   │   │   ├── smart-tempo.test.ts
│   │   │   │   ├── smart-tempo.ts
│   │   │   │   ├── tempo-map.ts
│   │   │   │   ├── tempo-nodes.ts
...
│   │   │   │   ├── multipass.ts
│   │   │   │   ├── seed.ts
│   │   │   │   ├── tempo-map-solver-multi-pass.test.ts
...
│   │   │   │   ├── text-anchor-bridge.api-audio-sync.test.ts
│   │   │   │   ├── text-anchor-bridge.api.test.ts
│   │   │   │   ├── text-anchor-bridge.chords.test.ts
