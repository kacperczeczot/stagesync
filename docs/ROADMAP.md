...
| **5.7**          | **Extended Notation & Chords**                                        | Import/Podgląd MuseScore (.mscz), Offline Reader mobile, Selection Filter OSMD, notacja akordów, 2-col Karaoke, Rehearsal Marks          | [TODO.md](./TODO.md)                                                                                                                                                                                                                                                               |
...
Hero: Personalizacja widoków partytur, import formatu MuseScore (.mscz) oraz zaawansowany tekst na ekranach wykonawców.

- **Obsługa plików MuseScore (.mscz):** import w Adminie, dekompresja i konwersja do MusicXML w locie
- **Offline Score Reader (Mobile & Web):** otwieranie i czytanie plików `.mscz` / `.musicxml` z pamięci urządzenia bez konieczności połączenia z hostem
